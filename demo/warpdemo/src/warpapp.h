...
namespace nap 
{
	 ...
	 * This example links to and uses it's own custom module: 'napwarp'.
	 * More information and documentation can be found at: https://www.napframework.com/doxygen/
     */
    class WarpApp : public App
	{
    public:
		/**
		 * Constructor
		 */
        WarpApp(nap::Core& core) : App(core) {}
    ...
    private:
		...
		ObjectPtr<EntityInstance>	mWarpEntity = nullptr;			///< Pointer to the entity that holds the warp components
		ObjectPtr<ParameterGUI>		mParameterGUI = nullptr;		///< Parameter GUI
